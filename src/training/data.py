...
class JsonlDataset(Dataset):
    def __init__(self, jsonl_filename, img_filename, split="val", max_txt_length=24, samples=None):
...
def get_dataset(args, is_train, max_txt_length=24):
    ...
    dataset = JsonlDataset(
        ...
        max_txt_length=max_txt_length, samples=args.train_samples if is_train else args.val_samples)
