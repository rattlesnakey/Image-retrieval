...
def get_default_params(model_name):
    ...
    elif model_name in ["ViT-B-32", "ViT-B-16", "CLIP-zh-base", "CLIP-zh-huge", "CLIP-zh-large"]:
...
def parse_args():
    ...
    parser.add_argument(
        "--adv_start_epoch", type=int, default=1, help="epoch to start adv train"
    )
    parser.add_argument(
        "--epochs", type=int, default=32, help="Number of epochs to train for."
    )
    parser.add_argument(
        "--patience", type=int, default=3, help="Number of epochs to tolerate."
    )
    
    parser.add_argument("--group_contrastive_loss_ratio", type=float, default=0.0, help="The ratio of Group Contrastive Loss")
    parser.add_argument("--group_contrastive_start_epoch", type=int, default=1, help="The epoch to start use Group Contrastive Loss")
    ...
    parser.add_argument(
        "--train_samples", type=int, default=None, help="How many train samples you use"
    )
    
    parser.add_argument(
        "--val_samples", type=int, default=None, help="How many dev samples you use"
    )
    parser.add_argument(
        "--save-most-recent",
        action="store_true",
    ...
    parser.add_argument(
        ...
        default="False",
        type=str,
        help="whether to use AWP training"
    )
    ...
    parser.add_argument(
        ...
        default="False",
        type=str,
        help="whether to use text smoothing"
    )
